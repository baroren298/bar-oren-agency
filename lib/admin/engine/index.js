 ...
 * (Section 13.17). Sprint 3.6 adds `createEntityAdapter` — a second,
 * generic adapter (Section 13.2) over the Entity/EntityVersion primitives,
 * exercising every engine service above with zero modifications to any of
 * them, closing Phase 3 success criterion #8 (Section 13.17: "at least two
 * adapters using the engine with zero engine modifications").
 * auditService / siteContentAdapter / seoAdapter / legalPageAdapter /
 * getVersionForPreview are later sprints — see Section 13.14 for the full
 * sub-phase sequence.
 */
...
export { createEntityAdapter } from './adapters/entityAdapter';
