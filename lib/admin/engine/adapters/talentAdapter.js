...
export const talentAdapter = {
   ...
   * See that method's header comment for why a brand-new talent's first
   * version is written straight as PUBLISHED instead of going through
   * proposalService/publishService.
   *
