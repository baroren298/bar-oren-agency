...
export const he = {
  ...
  seo: {
    ...
    // Talent SEO + Slug Management sprint — shown next to an empty field's
    // published value / preview: "empty" means the smart default applies,
    // never "broken".
    defaults: {
      usingDefault: "ברירת מחדל אוטומטית",
      name: "שם המיוצג/ת",
      bio: "הביוגרפיה",
