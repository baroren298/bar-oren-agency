...
export const he = {
  ...
  gallery: {
    ...
    previewModeNotice: {
      ...
      body: "עורך הגלריה נמצא כרגע במצב תצוגה מקדימה. העלאה, החלפה ושמירה יתאפשרו בספרינט עתידי.",
    },
    ...
    noProposedImagesDescription: "הוספת תמונות אמיתית תתאפשר בספרינט עתידי. אפשר לעקוב אחר ההתקדמות כאן כשהיא תיפתח.",
    ...
    replaceComingSoon: "החלפת תמונה תתאפשר בספרינט עתידי (העלאת קבצים).",
    addImageComingSoon: "הוספת תמונה תתאפשר בספרינט עתידי (העלאת קבצים).",
  },
  ...
  talent: {
    ...
    detail: {
      ...
      podcastTab: {
        ...
        comingSoonHint: "החלפת התמונה תתאפשר בספרינט עתידי — המבנה כבר מוכן לקבל אותה.",
