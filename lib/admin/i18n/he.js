...
export const he = {
  ...
  dashboard: {
    ...
    // The greeting summary counts Pending Approvals ONLY (spec §3) — hence
    // "לאישורך", which names the kind of attention, not the vaguer
    // "להתייחסותך" (used only in the zero state, where there is no kind).
    owner: {
      ...
      summaryNone: "אין כרגע פריטים שממתינים להתייחסותך.",
      summaryOne: "יש כרגע פריט אחד שממתין לאישורך.",
      summaryMany: (count) => `יש כרגע ${count} פריטים שממתינים לאישורך.`,
      sections: {
