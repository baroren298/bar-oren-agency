...
export const he = {
  ...
  talent: {
    ...
    create: {
      ...
      pageDescription:
        "הפרופיל נשמר ומתפרסם ישירות — אפשר להוסיף גלריה, רשתות חברתיות ו-SEO בעריכה אחרי היצירה.",
      ...
      fields: {
        ...
        slugHelper: "אותיות לטיניות קטנות, מספרים ומקפים בלבד — זו תהיה הכתובת הקבועה של המיוצג.",
        location: "מיקום",
        locationPlaceholder: "תל אביב",
        birthDate: "תאריך לידה",
        category: "קטגוריות",
        bioHe: "ביוגרפיה מלאה",
        bioHePlaceholder: "כמה פסקאות על המיוצג — רקע, ניסיון והתמחות.",
        bioEn: "ביוגרפיה באנגלית (אופציונלי)",
      },
      unsupportedNote: {
        title: "לא נתמך בשלב זה",
        // Explicit, honest limitations — surfaced in the UI rather than
        // silently dropped, per this sprint's "minimum required fields"
        // scope: role/title and a separate short bio/excerpt have no
        // column on TalentVersion yet (only category/tags and one full
        // bioHe/bioEn pair), and there is no image-upload pipeline yet
        // (imageAssetRepository.uploadImage is still an unimplemented
        // stub) — only an internal ImageAsset foreign key. Both can be
        // added later: a small additive schema change for the former, a
        // real upload pipeline for the latter.
        description:
          "תפקיד/תואר נפרד, תקציר קצר (excerpt) ותמונת פרופיל עדיין לא נתמכים בטופס היצירה — ניתן להוסיף תמונת פרופיל ושאר הפרטים בעריכה, לאחר חיבור מסד נתונים לתמונות.",
      },
      submit: "צור מיוצג",
      submitting: "יוצר…",
      cancel: "ביטול",
      ...
      errors: {
        ...
        slugRequired: "יש להזין כתובת (slug).",
        slugInvalid: "כתובת יכולה להכיל רק אותיות לטיניות קטנות, מספרים ומקפים, לדוגמה noa-cohen.",
        slugTaken: "כתובת (slug) זו תפוסה. נסה כתובת אחרת.",
        bioRequired: "יש להזין ביוגרפיה מלאה.",
        birthDateInvalid: "תאריך הלידה לא תקין.",
