...
export const he = {
  ...
  gallery: {
    ...
    actions: {
      ...
      moveDown: "הזז למטה",
      addImage: "+ הוסף תמונה",
      // Gallery Upload Sprint 2 — AddImageCard's active (non-disabled) label
      // once a real file input/upload call backs it, distinct from the
      // generic addImage label above (still used in preview mode / while
      // disabled, unchanged).
