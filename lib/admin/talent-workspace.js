...
export const TALENT_WORKSPACE_SECTIONS = [
  ...
  // Sprint 8A (Campaigns UI Prototype) — PROTOTYPE-only tab showing fake
  // in-memory campaign data (see app/admin/campaigns/_prototype/). Placed
  // right after Details: campaigns are core business context for a talent.
  // The tab's content is wired in app/admin/talent/[id]/page.jsx.
  { key: 'campaigns', label: he.talent.sections.campaigns },
