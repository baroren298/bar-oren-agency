...
export function extractTalentVersionFields(version) {
  ...
  return {
    ...
    // it isn't editable yet (not in updateTalentVersionFields'
    // WRITABLE_COLUMNS), but it must survive the Draft -> Publish flip or
    // the published podcast image would be lost.
