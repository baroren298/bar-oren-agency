export const siteConfig = {
  ...
  about: {
    ...
    subheadline: 'ניהול כישרונות ברמה הגבוהה ביותר.',

    story: [
      'בר אורן טאלנט אייג\'נסי היא סוכנות ייצוג בוטיק המתמחה בניהול אישי ומקצועי של כישרונות. אנחנו מאמינים שייצוג אמיתי מתחיל בהבנה עמוקה של כל אחד מהכישרונות שאנחנו מייצגים — לא רק מה שהם עושים, אלא מי שהם.',
      'כל כישרון שמצטרף לסוכנות עובר תהליך בחירה אישי. אנחנו לא מחפשים כמות — אנחנו מחפשים אנשים שאי אפשר להתעלם מהם. שיתופי פעולה שיוצאים מהסוכנות מבוססים על הבנה אמיתית, יחסים ארוכי טווח ומחויבות מלאה לשני הצדדים.',
    ],

    philosophy: [
      'ייצוג טוב מתחיל בהבנה. לא של מה שהכישרון עושה — אלא של מי שהוא.',
      'כל אחד מהכישרונות שאנו מייצגים נבחר באופן אישי. אנו מאמינים בעבודה קרובה, ביחסים ארוכי טווח, ובשיתופי פעולה שנוצרים מתוך הבנה אמיתית של המותג ושל האדם שמייצג אותו.',
      'בר אורן מנהלת את הסוכנות באופן אישי. כל שיתוף פעולה, כל קאסטינג, כל קמפיין — עובר דרכה.',
    ],

    founder: {
      name: 'בר אורן',
      title: 'מייסדת ומנהלת הסוכנות',
      statement: 'הקמתי את הסוכנות מתוך אמונה שכישרון ישראלי ראוי לייצוג ברמה הגבוהה ביותר. כל שיתוף פעולה שאני בונה — בין כישרון לבין מותג — מבוסס על הבנה אמיתית, יחסים ארוכי טווח, ומחויבות מלאה.',
    ...
    services: [
      {
        number: '01',
        title: 'ניהול כישרונות',
        description: 'ניהול מקצועי ואישי מלא — אסטרטגיה, תמחור, חוזים ופיתוח קריירה לטווח ארוך.',
      },
      {
        number: '02',
        title: 'שיתופי פעולה עם מותגים',
        description: 'חיבור בין כישרונות לבין מותגים מובילים, מתוך הבנה עמוקה של שני הצדדים.',
      },
      {
        number: '03',
        title: 'קמפיינים UGC',
        description: 'הפקת תוכן אותנטי ואיכותי לצרכי מותגים, עם כישרונות שמדברים אל הקהל הנכון.',
      },
      {
        number: '04',
  ...
  contactPage: {
    headline: 'בואו נדבר.',
    subheadline: 'לשיתופי פעולה, קאסטינג ופניות מותגים — בר אורן זמינה ישירות.',
